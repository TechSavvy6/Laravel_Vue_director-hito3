<template>
  <Modal
    :header="'Ocultar / mostrar columnas'"
    :modalType="'toggleColumn'"
    :paragraphs="paragraphs"
  >
      <div class="flex w-full flex-col mb-4">
        <span class="text-sm leading-6 mb-4"
          >Desmarca las columnas que deseas ocultar:</span
        >
        <div class="flex mb-4">
          <input
            type="checkbox"
      ...
      <button
        ...
        @click="$emit('setColumnsStatus', {'hideCols': checkedCols})"
      >
        Guardar cambios
      </button>
  </Modal>
...
export default {
  name: "toggle-column-component",
  components: {
    Modal,
  },
  data: function () {
    return {
      checkedCols: this.hideCols,
      paragraphs: [],
    };
  },
  props: {
